...
# [hydazz/obico](https://github.com/hydazz/docker-obico)

[![GitHub Release](https://img.shields.io/github/release/hydazz/docker-obico.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/hydazz/docker-obico/releases)
...
Simply pulling `ghcr.io/hydazz/obico:latest` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
services:
  obico:
    image: ghcr.io/hydazz/obico:latest
...
* Update the image: `docker pull ghcr.io/hydazz/obico:latest`
...
```bash
git clone https://github.com/hydazz/docker-obico.git
cd docker-obico
docker build \
  --no-cache \
  --pull \
  -t ghcr.io/hydazz/obico:latest .
```
